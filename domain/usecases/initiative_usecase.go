...
type InitiativeUseCase interface {
	...
	ListInitiatives(ctx context.Context, filter *entities.InitiativeFilter, userID int64) ([]*entities.InitiativeListResponse, error) // ATUALIZADO
	ListSubmittedInitiatives(ctx context.Context, userID int64) ([]*entities.InitiativeListResponse, error)
	ReviewInitiative(ctx context.Context, initiativeID int64, req *entities.ReviewInitiativeRequest, userID int64) error
